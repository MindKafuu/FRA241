  ...
  <body>
    <header>
        ...
        <div style="margin-top: -30px; margin-left: 500px">
            ...
            <a href="page4.php" class="btn1" style=" color: #79a2ff"><b>Inconvenient time</b></a>
            <a href="page5.php" class="btn1"><b>Classroom</b></a>
            <a href="page6.php" class="btn1"><b>Schedule</b></a>   
        </div>
        ...
        <div style=" margin-top: 40px; margin-left: 1100px;font-family: 'Work Sans', sans-serif" ><a href="#" class = "button3">
