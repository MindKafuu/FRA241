...
<html lang="en">
    <head>
        ...
        <!--style-->
        <link rel="stylesheet" type="text/css" href="css/page6-1.css">
...
<body>
  <header>
      ...
      <a href="page6.php" class="btn1" style=" color: #79a2ff"><b>Schedule</b></a>  
      </div>
      <div style="margin-top: -84px; margin-left: 1160px">
        ...
        <div style="margin-top: 50px;">
            ...
            <a href="page6.php" class="btn2"><b>ALL Schedule</b></a>
            <br><br>
